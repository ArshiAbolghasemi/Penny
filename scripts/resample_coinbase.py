"""
Normalize Coinbase LOB data to the same parquet schema as resample_binance.py.

Input directory (default: data/coinbase_data/):
...
Output directory (default: data/resampled/coinbase/):
...
-----
    ...
    uv run python scripts/resample_coinbase.py --data-dir data/coinbase_data --out-dir data/resampled/coinbase
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Normalize Coinbase LOB data to resampled parquet."
    )
    parser.add_argument(
        "--symbols",
        nargs="+",
    ...
    parser.add_argument(
        "--data-dir",
        default=None,
        help="Raw CSV directory (default: data/coinbase_data)",
    )
    parser.add_argument(
        "--out-dir",
        default=None,
        help="Output directory (default: data/resampled/coinbase)",
    )
