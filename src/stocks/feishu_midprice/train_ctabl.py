"""Train CTABL on Feishu A-share equity data.

Usage::

    uv run python -m stocks.feishu_midprice.train_ctabl configs/stocks/feishu_midprice/ctabl_h1.json
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "config", nargs="?", default="configs/stocks/feishu_midprice/ctabl_h1.json"
    )
    ...
    ckpt_dir = (
        ...
        / f"ctabl_{config.get('feature_mode', 'ofi')}_{stamp}"
    )
    ...
    logger.info(
        "CTABL [Feishu]  mode={}  symbols={}  n_features={}",
