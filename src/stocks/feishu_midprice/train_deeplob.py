...
Usage::
    ...
    uv run python -m stocks.feishu_midprice.train_deeplob configs/stocks/feishu_midprice/deeplob_h1.json
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "config", nargs="?", default="configs/stocks/feishu_midprice/deeplob_h1.json"
    )
