"""Train LinVAR on Feishu A-share equity data.

Usage::

    uv run python -m stocks.feishu_midprice.train_linvar configs/stocks/feishu_midprice/linvar_h1.json
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "config", nargs="?", default="configs/stocks/feishu_midprice/linvar_h1.json"
    )
    ...
    logger.info(
        "LinVAR [Feishu]  mode={}  symbols={}  n_features={}",
