...
Usage::
    ...
    uv run python -m stocks.feishu_midprice.train_logreg configs/stocks/feishu_midprice/logreg_h1.json
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "config", nargs="?", default="configs/stocks/feishu_midprice/logreg_h1.json"
    )
