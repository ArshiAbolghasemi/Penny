...
Usage::
    ...
    uv run python -m stocks.feishu.train_jumpgatelob configs/stocks/feishu/jumpgatelob_ofi.json
    uv run python -m stocks.feishu.train_jumpgatelob ... --process gaussian
    uv run python -m stocks.feishu.train_jumpgatelob ... --baseline
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "config",
        nargs="?",
        default="configs/stocks/feishu/jumpgatelob_ofi.json",
    )
