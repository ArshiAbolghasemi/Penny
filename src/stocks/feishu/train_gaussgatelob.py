...
architecture as ``stocks.feishu.train_jumpgatelob``, same three-term objective, same schedule
...
Usage::
    ...
    uv run python -m stocks.feishu.train_gaussgatelob ... --baseline
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "config",
        nargs="?",
        default="configs/stocks/feishu/gaussgatelob_ofi.json",
    )
    parser.add_argument(
        "--baseline",
        action="store_true",
